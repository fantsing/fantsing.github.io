+++
date = '2025-11-02T13:40:43+08:00'
title = '基于CNN的花朵识别'
...
GitHub链接：[GitHub - Arwin-Yu/Deep-Learning-Image-Classification-Models-Based-CNN-or-Attention: This project organizes classic images classification neural networks based on convolution or attention, and writes training and inference python scripts](https://github.com/Arwin-Yu/Deep-Learning-Image-Classification-Models-Based-CNN-or-Attention)
...
├── dataload/
│   ├── __pycache__/
│   │   ├── dataload_five_flower.cpython-36.pyc
│   │   ├── dataload_mini_imagenet.cpython-36.pyc
│   │   └── dataload_mini_imagenet.cpython-39.pyc
│   ├── dataload_five_flower.py
│   └── dataload_mini_imagenet.py
├── utils/
│   ├── __pycache__/
│   ├── __init__.py
│   ├── distribute_utils.py
...
其中`classic_models`是手动封装的一个模型库，可以随意使用。
